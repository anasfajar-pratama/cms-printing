...
<head>
    ...
    <title>DZ Jersey Pro — Produsen Jersey Custom & Textile Printing</title>
    <meta name="description" content="Produsen jersey custom, kain printing, dan hijab printing premium dengan kualitas terbaik, harga transparan, dan pengerjaan terpercaya.">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-content {
            ...
            justify-content: center; padding: 80px 24px 0;
            max-width: 800px;
        }
        .hero-eyebrow {
            display: flex; align-items: center; gap: 10px;
        ...
        .portfolio-card.large .portfolio-card-img-ph { height: 568px; }
        .portfolio-card-info {
...
<header id="navbar">
    <nav class="navbar-inner">
        <a href="#" class="navbar-logo">
            ...
            <div class="logo-text">
                <div class="name">DZ Jersey Pro</div>
        ...
        <a href="https://wa.me/6281382805858" target="_blank" class="navbar-cta">
            Request Penawaran
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <a href="#portfolio">Portfolio</a>
        <a href="#kontak">Kontak</a>
        <a href="https://wa.me/6281382805858" target="_blank" class="btn btn-orange">Request Penawaran</a>
    </div>
</header>
...
<section id="hero">
    <div class="hero-content container">
        <div class="hero-eyebrow">Sejak 2017 · Produsen Resmi · Indonesia</div>
        <h1 class="hero-title">
            Produsen Jersey Custom<br>
            <span class="amp">&amp;</span>
            Textile Printing<br>
            <span class="italic-word">Berkualitas.</span>
        </h1>
        <p class="hero-desc">
            Melayani produksi jersey custom, kain printing, dan hijab printing premium
            dengan kualitas terbaik, harga transparan, dan pengerjaan terpercaya.
        </p>
        <div class="hero-actions">
            <a href="https://wa.me/6281382805858" target="_blank" class="btn btn-green">
            ...
            <a href="https://wa.me/6281382805858" target="_blank" class="btn btn-orange">
                Request Penawaran
    ...
    <div class="container">
        <div class="about-grid">
            ...
            <div class="about-right">
                ...
                <div class="about-img img-ph" style="height: 520px;">
                    {{-- Ganti dengan foto workshop Anda --}}
                    <span>Foto Workshop / Produksi</span>
                </div>
...
<section id="layanan" class="section" style="padding-top: 0;">
    <div class="container">
        ...
        <div class="layanan-grid">
            <!-- Custom Jersey (wide, 2 cols) -->
            <div class="layanan-card wide">
                <div class="layanan-card-img-placeholder img-ph" style="height:100%; min-height: 340px;">
                    {{-- Foto koleksi jersey --}}
                </div>
                <div class="layanan-card-top">
                    <span class="layanan-card-tag">Full Print Sublimasi</span>
                </div>
            ...
            <div class="layanan-card">
                <div class="layanan-card-img-placeholder img-ph" style="height: 100%; min-height: 170px;">
                    {{-- Foto textile printing --}}
                </div>
                <div class="layanan-card-top">
        ...
        <a href="https://wa.me/6281382805858" target="_blank" class="layanan-wa">
            Tanya via WhatsApp
            <svg viewBox="0 0 24 24"><path d="M7 17L17 7M17 7H7M17 7v10"/></svg>
        </a>
    </div>
            ...
            <div class="kalk-box">
                ...
                <div class="kalk-field">
                    ...
                    <select class="kalk-select" id="kalkBahan" onchange="updateEstimasi()">
                        <option value="65000">Dry Fit — Rp 65.000/pcs</option>
                        <option value="85000">Milano — Rp 85.000/pcs</option>
                        <option value="75000">Drifit Polos — Rp 75.000/pcs</option>
                        <option value="80000">Diadora — Rp 80.000/pcs</option>
                        <option value="70000">Paragon — Rp 70.000/pcs</option>
                        <option value="120000">Parasut — Rp 120.000/pcs</option>
                    </select>
                </div>
                <div class="kalk-field">
                    <label>
...
<section id="material" class="section">
    ...
    <div class="container">
        <div class="material-grid">
            ...
            <div class="material-card">
                <div class="material-num">04</div>
                <div class="material-cat">Jersey</div>
                <div class="material-name">Diadora</div>
                <div class="material-desc">Serat tebal, tidak nerawang, warna pekat dan kontras.</div>
                <div class="material-price-row">
                    <div class="material-mulai">Mulai</div>
                    <div class="material-price">Rp 80.000<span>/pcs</span></div>
                </div>
            </div>
            <div class="material-card">
                <div class="material-num">05</div>
                <div class="material-cat">Sport</div>
                <div class="material-name">Paragon</div>
                <div class="material-desc">Elastis, cepat kering, permukaan halus untuk print sublim.</div>
                <div class="material-price-row">
                    <div class="material-mulai">Mulai</div>
                    <div class="material-price">Rp 70.000<span>/pcs</span></div>
                </div>
            </div>
            <div class="material-card">
                <div class="material-num">06</div>
                <div class="material-cat">Jaket</div>
                <div class="material-name">Parasut</div>
                <div class="material-desc">Ringan anti-gerimis, ideal untuk training jacket &amp; outerwear.</div>
                <div class="material-price-row">
                    <div class="material-mulai">Mulai</div>
                    <div class="material-price">Rp 120.000<span>/pcs</span></div>
                </div>
            </div>
            <div class="material-card">
                <div class="material-num">07</div>
                <div class="material-cat">Hijab</div>
                <div class="material-name">Satin Velvet</div>
                <div class="material-desc">Sutra sintetis dengan kilau lembut — elegan untuk hijab premium.</div>
                <div class="material-price-row">
                    <div class="material-mulai">Mulai</div>
                    <div class="material-price">Rp 55.000<span>/pcs</span></div>
                </div>
            </div>
            <div class="material-card">
                <div class="material-num">08</div>
                <div class="material-cat">Hijab</div>
                <div class="material-name">Voal Premium</div>
                <div class="material-desc">Ringan, adem, warna sablon halus — bestseller hijab printing.</div>
                <div class="material-price-row">
                    <div class="material-mulai">Mulai</div>
                    <div class="material-price">Rp 45.000<span>/pcs</span></div>
                </div>
            </div>
            <div class="material-card">
                <div class="material-num">09</div>
                <div class="material-cat">Hijab</div>
                <div class="material-name">Ceruti Babydoll</div>
                <div class="material-desc">Flowy &amp; jatuh cantik, pilihan tren hijab syar'i modern.</div>
                <div class="material-price-row">
                    <div class="material-mulai">Mulai</div>
                    <div class="material-price">Rp 50.000<span>/pcs</span></div>
                </div>
            </div>
        </div>
    </div>
...
<section id="portfolio" class="section" style="padding-top: 0;">
    <div class="container">
        <div class="portfolio-header">
            ...
            <a href="https://instagram.com/dzscarve" target="_blank" class="portfolio-ig">
        ...
        <div class="portfolio-grid">
            ...
            <div class="portfolio-card large">
                <div class="portfolio-card-img-ph img-ph" style="height:100%; min-height: 568px;"></div>
                <div class="portfolio-card-info">
                    <div class="portfolio-card-cat">Basket</div>
                    <div class="portfolio-card-title">Jersey Basket — Team Rising Star</div>
                </div>
            </div>
            <!-- Top right -->
            <div class="portfolio-card" style="grid-column: 2; grid-row: 1;">
                <div class="portfolio-card-img-ph img-ph"></div>
                <div class="portfolio-card-info">
                    <div class="portfolio-card-cat">Textile</div>
                    <div class="portfolio-card-title">Sublimation Printing — Batch 200pcs</div>
                </div>
            </div>
            <!-- Bottom right -->
            <div class="portfolio-card" style="grid-column: 2; grid-row: 2;">
                <div class="portfolio-card-img-ph img-ph"></div>
                <div class="portfolio-card-info">
                    <div class="portfolio-card-cat">Hijab</div>
                    <div class="portfolio-card-title">Voal Printing — Double Z Collection</div>
                </div>
            </div>
            <!-- Top far right -->
            <div class="portfolio-card" style="grid-column: 3; grid-row: 1;">
                <div class="portfolio-card-img-ph img-ph"></div>
                <div class="portfolio-card-info">
                    <div class="portfolio-card-cat">Workshop</div>
                    <div class="portfolio-card-title">Line Produksi Jahit — Internal</div>
                </div>
            </div>
            <!-- Middle far right -->
            <div class="portfolio-card" style="grid-column: 3; grid-row: 2;">
                <div class="portfolio-card-img-ph img-ph"></div>
                <div class="portfolio-card-info">
                    <div class="portfolio-card-cat">Material</div>
                    <div class="portfolio-card-title">Kain Premium In-House</div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="area-header">
            <div>
                ...
                <h2 class="area-title">
                    Melayani <span class="orange">12+ kota</span> di seluruh<br>Indonesia.
                </h2>
            </div>
            <p class="area-desc">
        ...
        <div class="area-group">
            ...
            <div class="area-tags">
                ...
                <a href="https://wa.me/6281382805858?text=Halo, saya dari {{ $kota }} ingin order Jersey Custom" target="_blank" class="area-tag">
                    <svg viewBox="0 0 24 24"><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><circle cx="12" cy="11" r="3"/></svg>
                    Jersey {{ $kota }}
                </a>
                @endforeach
        ...
        <div class="area-group">
            ...
            <div class="area-tags">
                ...
                <a href="https://wa.me/6282345556927?text=Halo, saya dari {{ $kota }} ingin order Hijab Printing Custom" target="_blank" class="area-tag">
                    <svg viewBox="0 0 24 24"><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><circle cx="12" cy="11" r="3"/></svg>
                    Hijab {{ $kota }}
                </a>
                @endforeach
        ...
        <div class="trust-grid">
            <div>
                ...
                <div class="trust-actions">
                    <a href="https://wa.me/6282345556927" target="_blank" class="btn btn-green" style="font-size:13px; padding:12px 18px;">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M11.998 2C6.477 2 2 6.477 2 12c0 1.989.58 3.842 1.582 5.402L2 22l4.744-1.546A9.96 9.96 0 0011.998 22c5.523 0 10-4.477 10-10S17.521 2 11.998 2z"/></svg>
                        WA Double Z Scarve
                    </a>
                    <a href="https://instagram.com/dzscarve" target="_blank" class="btn btn-outline" style="font-size:13px; padding:12px 18px;">
...
<section id="kontak" class="section">
    <div class="container">
        ...
        <div class="kontak-wa-grid">
            <a href="https://wa.me/6281382805858" target="_blank" class="kontak-wa">
                <div class="wa-icon">
                ...
                <div class="wa-num">+6281382805858</div>
            </a>
            <a href="https://wa.me/6282345556927" target="_blank" class="kontak-wa">
                <div class="wa-icon">
                    <svg viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M11.998 2C6.477 2 2 6.477 2 12c0 1.989.58 3.842 1.582 5.402L2 22l4.744-1.546A9.96 9.96 0 0011.998 22c5.523 0 10-4.477 10-10S17.521 2 11.998 2zm0 18.198a8.19 8.19 0 01-4.187-1.148l-.299-.178-3.108 1.015 1.039-3.008-.196-.31A8.196 8.196 0 013.8 12c0-4.519 3.679-8.198 8.198-8.198S20.196 7.481 20.196 12c0 4.519-3.679 8.198-8.198 8.198z"/></svg>
                </div>
                <div class="arrow">
                ...
                <div class="wa-num">+6282345556927</div>
            </a>
        </div>
        ...
        <div class="kontak-info-grid">
            <div class="kontak-info-item">
                ...
                <a href="mailto:cs@dzjerseypro.co.id" class="kontak-info-val">cs@dzjerseypro.co.id</a>
            </div>
            <div class="kontak-info-item">
                <div class="kontak-info-icon">
                    <svg viewBox="0 0 24 24"><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><circle cx="12" cy="11" r="3"/></svg>
                ...
                <a href="https://maps.google.com" target="_blank" class="kontak-info-val">Lihat di Google Maps</a>
            ...
            <div class="kontak-info-item">
                ...
                <a href="https://instagram.com/dzscarve" target="_blank" class="kontak-info-val">@dzscarve</a>
...
═══════════════════════════════════════════════════ -->
<footer>
    <div class="copy">© 2026 DZJERSEYPRO.CO.ID · DOUBLE Z SCARVE</div>
...
function switchService(btn) {
    ...
    select.innerHTML = '';
    serviceOptions[service].forEach(opt => {
